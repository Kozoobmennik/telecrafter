...
public class Whitelist implements CommandExecutor {
    ...
    public Whitelist(TelegramProvider telegram, MinecraftProvider minecraft) {
    ...
    public String getDescription() {
        return "добавить никнейм игрока в вайтлист";
    }
        ...
        try {
            minecraft.runCommand(
                    ...
                    successful -> telegram.sendMessage(
                            chatId,
                            successful ? "Игрок добавлен в вайтлист!" : "Что-то пошло не так."
                    )
            );
